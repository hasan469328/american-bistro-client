    ...
    <div className="carousel w-full mt-12">
      <div id="slide1" className="carousel-item relative w-full">
        <div>
          ...
          />
          <div className="hero absolute text-white top-0 lg:top-20">
            <div className="hero-content flex-col lg:flex-row-reverse">
              
              <div className="max-w-md">
                <h1 className="xl lg:text-5xl font-bold lg:mb-4 text-center underline">Our Features</h1>
      ...
      <div>
          ...
          <div className="hero absolute text-white top-0 lg:top-20">
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div className="max-w-md">
                <h1 className="xl lg:text-5xl font-bold lg:mb-4">Our Features</h1>
